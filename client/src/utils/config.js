export const config = [
  ...
  {
    ACT: "act-237",
    Leads: ["kavya", "raja", "hari", "lilly", "mahesh"],
    Query: `assignee in ("mahesh.kanthaguntla@one.verizon.com","shatakshi.ajay.deshpande@one.verizon.com") AND issuetype in ("bug","sub-task") AND updated >= -7d`,
  },
];
